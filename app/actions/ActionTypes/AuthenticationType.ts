...
export type LoginAction = ILoginRequestAction | ILoginFailAction | ILoginSuccessAction

export type ISignUpAction = ISignUpRequestAction | ISignUpFailed | ISignUpSuccessAction
