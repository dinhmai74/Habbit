...
class Calendar extends Component {
  static propTypes = {
    ...
    hideArrowLeft: PropTypes.bool,

    hideArrowRight: PropTypes.bool,
  ...
  getWatchingMonth = () => this.state.currentMonth.toString('yyyy-MM');
  ...
  render() {
    ...
    return (
      <View style={[this.style.container, this.props.style]}>
        <CalendarHeader
          theme={this.props.theme}
          hideArrowLeft={this.props.hideArrowLeft}
          hideArrowRight={this.props.hideArrowRight}
