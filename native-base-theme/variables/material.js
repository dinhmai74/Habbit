...
export default {
  ...
  // Color
  // brandPrimary: "#3F51B5",
  brandPrimary: Colors.buttonColorInColoredBackground,
  brandInfo: '#62B1F6',
  brandSuccess: Colors.success,
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  brandDark: Colors.darkButtonColor,
  brandLight: '#f4f4f4',
  ...
  // Font
  DefaultFontSize: Fonts.size.base,
  fontFamily: Fonts.type.base,
  fontSizeBase: Fonts.size.base,
  get fontSizeH1() {
  ...
  // InputGroup
  inputFontSize: Fonts.size.input,
  ...
  titleFontSize: Fonts.size.h6,
  subTitleFontSize: Fonts.size.medium,
